...
namespace Banco
{
    public class ServicioParametrizacion
    {
        ...
        public RespuestaListas<Zona> ConsultarTodosZonas(bool incluirNoHab)
        {
            ...
            ServicioFachadaOlimpia.RespuestaLogOfZonaVMmd83opfb Todos = sb.ConsultarTodosZonas();
            ...
            {
                List<ServicioFachadaOlimpia.ZonaVM> Result = Todos.Lista.ToList();
        ...
        {
            RespuestaListas<Zona> Rl = new RespuestaListas<Zona>();
            ServicioFachadaOlimpia.RespuestaEntidadOfZonaVMmd83opfb Todos = sb.ConsultarZonaPorId(idZona);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.ZonaVM Result = Todos.Entidad;
                Rl.Lista.Add(new Zona
                {
        ...
        {
            ServicioFachadaOlimpia.ZonaVM Registo = new ServicioFachadaOlimpia.ZonaVM()
            {
                IdZona = Zona.IdZona,
        ...
        public RespuestaListas<Oficina> ConsultarTodosOficinas(bool incluirNoHab)
        {
            ...
            ServicioFachadaOlimpia.RespuestaLogOfOficinaVMozTLvJBi Todos = sb.ConsultarTodosOficinas(incluirNoHab);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                List<ServicioFachadaOlimpia.OficinaVM> Result = Todos.Lista.ToList();
        ...
        {
            RespuestaListas<Oficina> Rl = new RespuestaListas<Oficina>();
            ServicioFachadaOlimpia.RespuestaEntidadOfOficinaVMozTLvJBi Todos = sb.ConsultarOficinaPorId(idOficina, activo);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.OficinaVM Result = Todos.Entidad;
                Rl.Lista.Add(new Oficina
                {
        ...
        {
            ServicioFachadaOlimpia.OficinaVM Registo = new ServicioFachadaOlimpia.OficinaVM()
            {
        ...
        public RespuestaListas<Rol> ConsultarTodosRoles(bool incluirNoHab)
        {
            ...
            ServicioFachadaOlimpia.RespuestaLogOfRolVMB_SOyXRSX Todos = sb.ConsultarTodosRoles(incluirNoHab);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                List<ServicioFachadaOlimpia.RolVM> Result = Todos.Lista.ToList();
        ...
        {
            RespuestaListas<Rol> Rl = new RespuestaListas<Rol>();
            ServicioFachadaOlimpia.RespuestaEntidadOfRolVMB_SOyXRSX Todos = sb.ConsultarRolPorId(idRol, activo);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.RolVM Result = Todos.Entidad;
                Rl.Lista.Add(new Rol
                {
                    IdRol = Result.IdRol,
                    Codigo = Result.Codigo,
        ...
        {
            ServicioFachadaOlimpia.RolVM Registo = new ServicioFachadaOlimpia.RolVM()
            {
                IdRol = Rol.IdRol,
                Codigo = Rol.Codigo,
        ...
        public RespuestaListas<Usuario> ConsultarTodosUsuarios(bool incluirNoHab)
        {
            ...
            ServicioFachadaOlimpia.RespuestaLogOfUsuarioVMGvIObl1R Todos = sb.ConsultarTodosUsuarios(incluirNoHab);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                List<ServicioFachadaOlimpia.UsuarioVM> Result = Todos.Lista.ToList();
        ...
        {
            RespuestaListas<Usuario> Rl = new RespuestaListas<Usuario>();
            ServicioFachadaOlimpia.RespuestaEntidadOfUsuarioVMGvIObl1R Todos = sb.ConsultarUsuarioPorId(usuario, Activo);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.UsuarioVM Result = Todos.Entidad;
                Rl.Lista.Add(new Usuario
                {
        ...
        {
            ServicioFachadaOlimpia.UsuarioVM Registo = new ServicioFachadaOlimpia.UsuarioVM()
            {
        ...
        public RespuestaListas<Entidades.Parametrizacion.Servicio> ConsultarTodosServicios(bool incluirNoHab)
        {
            ...
            ServicioFachadaOlimpia.RespuestaLogOfServicioVMyQgq8qZw Todos = sb.ConsultarTodosServicios(incluirNoHab);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                List<ServicioFachadaOlimpia.ServicioVM> Result = Todos.Lista.ToList();
        ...
        {
            RespuestaListas<Entidades.Parametrizacion.Servicio> Rl = new RespuestaListas<Entidades.Parametrizacion.Servicio>();
            ServicioFachadaOlimpia.RespuestaEntidadOfServicioVMyQgq8qZw Todos = sb.ConsultarServicioPorId(idServicio, activo);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.ServicioVM Result = Todos.Entidad;
                Rl.Lista.Add(new Entidades.Parametrizacion.Servicio
                {
        ...
        {
            ServicioFachadaOlimpia.ServicioVM Registo = new ServicioFachadaOlimpia.ServicioVM()
            {
        ...
        public RespuestaListas<Producto> ConsultarTodosProductos(bool incluirNoHab)
        {
            ...
            ServicioFachadaOlimpia.RespuestaLogOfProductoVMBrCV2MnN Todos = sb.ConsultarTodosProductos(incluirNoHab);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                List<ServicioFachadaOlimpia.ProductoVM> Result = Todos.Lista.ToList();
        ...
        {
            RespuestaListas<Producto> Rl = new RespuestaListas<Producto>();
            ServicioFachadaOlimpia.RespuestaEntidadOfProductoVMBrCV2MnN Todos = sb.ConsultarProductoPorId(idServicio, activo);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.ProductoVM Result = Todos.Entidad;
                Rl.Lista.Add(new Producto
                {
        ...
        {
            ServicioFachadaOlimpia.ProductoVM Registo = new ServicioFachadaOlimpia.ProductoVM()
            {
        ...
        {
            RespuestaListas<Parametros> Rl = new RespuestaListas<Parametros>();
            ServicioFachadaOlimpia.RespuestaEntidadOfParametroVMrJHE_SDAL Todos = sb.ConsultarParametroPorId(idParametro);
            ...
            if (Todos.Estado == ServicioFachadaOlimpia.RespuestaEstadoRespuesta.Ok)
            {
                ServicioFachadaOlimpia.ParametroVM Result = Todos.Entidad;
                Rl.Lista.Add(new Parametros
                {
        ...
        {
            ServicioFachadaOlimpia.ParametroVM Registo = new ServicioFachadaOlimpia.ParametroVM()
            {
